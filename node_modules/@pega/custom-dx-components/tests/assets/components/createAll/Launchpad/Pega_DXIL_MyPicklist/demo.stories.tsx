...
import PegaDxilMyPicklist from './index';

const meta: Meta<typeof PegaDxilMyPicklist> = {
...
export default meta;
type Story = StoryObj<typeof PegaDxilMyPicklist>;

export const BasePegaDxilMyPicklist: Story = args => {
  ...
  return (
    <>
      <PegaDxilMyPicklist {...props} {...args} />
    </>
  );
};

BasePegaDxilMyPicklist.args = {
  label: configProps.label,
  helperText: configProps.helperText,
  placeholder: configProps.placeholder,
  testId: configProps.testId,
