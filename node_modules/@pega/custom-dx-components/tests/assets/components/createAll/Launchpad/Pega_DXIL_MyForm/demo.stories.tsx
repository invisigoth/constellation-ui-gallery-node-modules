...
import PegaDxilMyForm from './index';
...
const meta: Meta<typeof PegaDxilMyForm> = {
...
export default meta;
type Story = StoryObj<typeof PegaDxilMyForm>;
...
export const BasePegaDxilMyForm: Story = args => {
  const props = {
    NumCols: 1,
  ...
  return (
    <>
      <PegaDxilMyForm {...props} {...args}>{regionAChildren}</PegaDxilMyForm>
    </>
  );
};

BasePegaDxilMyForm.args = {};
