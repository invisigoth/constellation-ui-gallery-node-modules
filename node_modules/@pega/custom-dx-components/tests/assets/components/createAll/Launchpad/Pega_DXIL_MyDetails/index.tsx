...
// interface for props
interface PegaDxilMyDetailsProps extends PConnFieldProps {
...
function PegaDxilMyDetails(props: PegaDxilMyDetailsProps) {
...
export default withConfiguration(PegaDxilMyDetails);
