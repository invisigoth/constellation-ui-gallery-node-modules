...
// interface for props
interface PegaDxilMyEmailProps extends PConnFieldProps {
...
function PegaDxilMyEmail(props: PegaDxilMyEmailProps) {
 const {
    getPConnect,
    value,
    placeholder,
...
export default withConfiguration(PegaDxilMyEmail);
