...
import StyledPegaDxilMyRadiobuttonsWrapper from './styles';


// interface for props
interface PegaDxilMyRadiobuttonsProps extends PConnFieldProps {
...
function PegaDxilMyRadiobuttons(props: PegaDxilMyRadiobuttonsProps) {
  const {
    getPConnect,
    value,
    label,
  ...
  return (
    <StyledPegaDxilMyRadiobuttonsWrapper>
    <RadioButtonGroup
      {...additionalProps}
      label={label}
...
export default withConfiguration(PegaDxilMyRadiobuttons);
