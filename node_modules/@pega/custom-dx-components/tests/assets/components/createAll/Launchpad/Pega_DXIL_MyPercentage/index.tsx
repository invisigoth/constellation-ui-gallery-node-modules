...
// interface for props
interface PegaDxilMyPercentageProps extends PConnFieldProps {
...
function PegaDxilMyPercentage(props: PegaDxilMyPercentageProps) {
  const {
    getPConnect,
    value,
    placeholder,
...
export default withConfiguration(PegaDxilMyPercentage);
