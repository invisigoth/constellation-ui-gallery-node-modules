...
import { pyReviewRaw, pyReviewResolved, regionChildrenResolved } from './mock';
import StatusWorkRenderer from './StatusWork';

const meta: Meta<typeof PegaDxilMyTwoColumnDetails> = {
...
export default meta;
type Story = StoryObj<typeof PegaDxilMyTwoColumnDetails>;
...
export const BasePegaDxilMyTwoColumnDetails: Story = args => {
  const props = {
  ...
  return (
    <PegaDxilMyTwoColumnDetails {...props} {...args}>
      {regionAChildren}
      {regionBChildren}
...
BasePegaDxilMyTwoColumnDetails.args = {};
