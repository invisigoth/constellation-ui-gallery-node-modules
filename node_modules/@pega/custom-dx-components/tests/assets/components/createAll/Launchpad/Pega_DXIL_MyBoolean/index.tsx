...
function PegaDxilMyBoolean(props: PegaDxilMyBooleanProps) {
  const {
    getPConnect,
    value = false,
    label = '',
  ...
  if (displayMode) {
    ...
    displayComponent = (
      // @ts-ignore
      <PegaDxilMyBoolean value={value} trueLabel={trueLabel} falseLabel={falseLabel} />
    );
  }
...
export default withConfiguration(PegaDxilMyBoolean);
