...
import StyledPegaDxilMySearchboxWrapper from './styles';

// interface for props
interface PegaDxilMySearchboxProps extends PConnFieldProps {
...
interface PegaDxilMySearchboxPropsSubSet {
  selected: any;
  actualValue: any;
  isTableFormatter?: boolean;
  formatter: string;
...
const DisplayComponent = (props: PegaDxilMySearchboxPropsSubSet) => {
...
function PegaDxilMySearchbox(props: PegaDxilMySearchboxProps) {
  const {
    getPConnect,
    value,
    placeholder,
  ...
  const displayComponent = useMemo(() => {
    return <StyledPegaDxilMySearchboxWrapper>
    <DisplayComponent {...{ selected, actualValue, isTableFormatter, formatter }} />
    </StyledPegaDxilMySearchboxWrapper>;
...
export default withConfiguration(PegaDxilMySearchbox);
