...
import PegaDxilMyPage from './index';
import { pyHome1Resolved, pyHome1Raw } from './mock';

const meta: Meta<typeof PegaDxilMyPage> = {
...
export default meta;
type Story = StoryObj<typeof PegaDxilMyPage>;

export const BasePegaDxilMyPage: Story = args => {
  if (!window.PCore) {
    window.PCore = {};
  }
  ...
  return (
    <>
      <PegaDxilMyPage {...props} {...args}>{regionAChildren}</PegaDxilMyPage>
    </>
  );
};

BasePegaDxilMyPage.args = {};
