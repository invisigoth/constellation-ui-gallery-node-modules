...
import PegaDxilMyPageCaseWidget from './index';

import { configProps, operatorDetails } from './mock';

const meta: Meta<typeof PegaDxilMyPageCaseWidget> = {
...
export default meta;
type Story = StoryObj<typeof PegaDxilMyPageCaseWidget>;
...
export const BasePegaDxilMyPageCaseWidget: Story = args => {
...
return (
    <>
      <PegaDxilMyPageCaseWidget {...props} {...args} />
    </>
  );
};

BasePegaDxilMyPageCaseWidget.args = {};
