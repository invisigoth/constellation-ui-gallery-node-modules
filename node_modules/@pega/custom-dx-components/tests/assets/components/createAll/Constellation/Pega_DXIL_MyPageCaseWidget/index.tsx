...
// interface for props
interface PegaDxilMyPageCaseWidgetProps extends PConnFieldProps {
...
function PegaDxilMyPageCaseWidget(props: PegaDxilMyPageCaseWidgetProps) {
  ...
  return user.userId && user.userName ? (
    <StyledPegaDxilMyPageCaseWidgetWrapper>
      <Card>
...
export default withConfiguration(PegaDxilMyPageCaseWidget);
