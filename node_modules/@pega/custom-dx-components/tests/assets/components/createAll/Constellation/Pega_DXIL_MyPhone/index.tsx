...
// interface for props
interface PegaDxilMyPhoneProps extends PConnFieldProps {
...
function PegaDxilMyPhone(props: PegaDxilMyPhoneProps) {
  const {
    getPConnect,
    value,
...
export default withConfiguration(PegaDxilMyPhone);
