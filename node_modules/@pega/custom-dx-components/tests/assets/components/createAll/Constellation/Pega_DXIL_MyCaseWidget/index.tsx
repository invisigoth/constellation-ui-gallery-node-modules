...
// interface for props
interface PegaDxilMyCaseWidgetProps extends PConnFieldProps {
...
function PegaDxilMyCaseWidget(props: PegaDxilMyCaseWidgetProps) {
...
export default withConfiguration(PegaDxilMyCaseWidget);
