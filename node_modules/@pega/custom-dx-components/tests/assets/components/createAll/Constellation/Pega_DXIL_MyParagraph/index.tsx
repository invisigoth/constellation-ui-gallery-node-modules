...
// interface for props
interface PegaDxilMyParagraphProps extends PConnFieldProps {
...
function PegaDxilMyParagraph(props: PegaDxilMyParagraphProps) {
  const {
    getPConnect,
    value,
    hideLabel = false,
 ...
 // BUG-547602: Temporary type coercion for 8.5 until DXAPIs are enhanced to pass original pxViewMetadata JSON, respecting boolean primitives
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledPegaDxilMyParagraphWrapper>
      {displayComp}
      </StyledPegaDxilMyParagraphWrapper>
    ) : (
      <StyledPegaDxilMyParagraphWrapper>
...
export default withConfiguration(PegaDxilMyParagraph);
