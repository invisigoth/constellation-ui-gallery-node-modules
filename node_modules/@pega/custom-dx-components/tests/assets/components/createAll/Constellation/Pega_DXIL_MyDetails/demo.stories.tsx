...
const meta: Meta<typeof PegaDxilMyDetails> = {
...
export default meta;
type Story = StoryObj<typeof PegaDxilMyDetails>;
...
export const BasePegaDxilMyDetails: Story = args => {
  const props = {
  ...
  return (
    <>
      <PegaDxilMyDetails {...props} {...args}>{regionAChildren}</PegaDxilMyDetails>
    </>
  );
};

BasePegaDxilMyDetails.args = {};
