...
// interface for props
interface PegaDxilMyCurrencyProps extends PConnFieldProps {
...
function PegaDxilMyCurrency(props: PegaDxilMyCurrencyProps) {
  const {
    getPConnect,
    value = 0,
    placeholder,
...
export default withConfiguration(PegaDxilMyCurrency);
