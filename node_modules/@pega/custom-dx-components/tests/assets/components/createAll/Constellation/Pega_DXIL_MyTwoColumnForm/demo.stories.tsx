...
import PegaDxilMyTwoColumnForm from './index';
...
const meta: Meta<typeof PegaDxilMyTwoColumnForm> = {
...
export default meta;
type Story = StoryObj<typeof PegaDxilMyTwoColumnForm>;
...
export const BasePegaDxilMyTwoColumnForm: Story = args => {
  const props = {
  ...
  return (
    <PegaDxilMyTwoColumnForm {...props} {...args}>
      {regionAChildren}
      {regionBChildren}
...
BasePegaDxilMyTwoColumnForm.args = {};
