...
// interface for props
interface PegaDxilMyDateTimeProps extends PConnFieldProps {
...
function PegaDxilMyDateTime (props: PegaDxilMyDateTimeProps)  {
  const {
    getPConnect,
    value,
    validatemessage,
...
export default withConfiguration(PegaDxilMyDateTime);
