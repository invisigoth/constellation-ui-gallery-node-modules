...
// interface for props
interface PegaDxilMyTimeOfDayProps extends PConnFieldProps {
...
function PegaDxilMyTimeOfDay (props: PegaDxilMyTimeOfDayProps)  {
  const {
    getPConnect,
    value,
    validatemessage,
...
export default withConfiguration(PegaDxilMyTimeOfDay);
