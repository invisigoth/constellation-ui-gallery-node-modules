 ...
 */
export function getAllFields(pConnect: Function) {
  ...
  if (hasRegions) {
    allFields = metadata.children.map((region: any) =>
      region.children.map((field: any) => {
 ...
 */
export function prepareComponentInCaseSummary(configObject: any, getPConnect: Function, displayMode: string) {
...
export function getFilteredFields(getPConnect: Function) {
 ...
 */
export function getLayoutDataFromRegion(regionData: object[]) {
 ...
 */
export function getIsAssignmentView(pConnect: Function) {
 ...
 */
export function getInstructions(pConnect: Function, instructions: string = 'casestep') {
   // @ts-ignore
