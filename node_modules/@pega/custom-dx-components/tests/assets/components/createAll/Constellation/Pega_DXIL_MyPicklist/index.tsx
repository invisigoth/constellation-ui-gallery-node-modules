...
// interface for props
interface PegaDxilMyPicklistProps extends PConnFieldProps {
...
function PegaDxilMyPicklist(props: PegaDxilMyPicklistProps) {
  const {
    getPConnect,
    value,
    label,
...
export default withConfiguration(PegaDxilMyPicklist);
