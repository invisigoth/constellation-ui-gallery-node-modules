export default {
    ...
    condition_builder_compare_with_numeric_range_value: 'Numeric range value',
    condition_builder_compare_with_date_range_value: 'Date range value',
    condition_builder_compare_with_time_range_value: 'Time range value',
    ...
    delete_decision_step: 'Select outcome that you want to retain. The remaining highlighted outcomes will be deleted',
    ...
    delete_referenced_step_error: 'This step can\'t be deleted as it is referenced by a "Go to" step.',
