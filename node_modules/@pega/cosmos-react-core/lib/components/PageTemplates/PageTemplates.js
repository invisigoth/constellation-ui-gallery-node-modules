...
const PageLayout = forwardRef(function PageLayout({ regions, cols = `repeat(${regions.length}, minmax(0, 1fr))`, title, icon, path, actions, banners, tabs, as, header, regionsRef, scrollContent = false, ...restProps }, ref) {
...
export const TwoColumnPage = forwardRef(function TwoColumnPage({ a, b, ...restProps }, ref) {
    return (_jsx(PageLayout, { regions: [a, b], ref: ref, ...restProps, cols: 'repeat(2, minmax(0, 1fr))' }));
});
export const ThreeColumnPage = forwardRef(function ThreeColumnPage({ a, b, c, ...restProps }, ref) {
    return (_jsx(PageLayout, { regions: [a, b, c], ref: ref, ...restProps, cols: 'repeat(3, minmax(0, 1fr))' }));
});
export const FourColumnPage = forwardRef(function FourColumnPage({ a, b, c, d, ...restProps }, ref) {
    return (_jsx(PageLayout, { regions: [a, b, c, d], ref: ref, ...restProps, cols: 'repeat(4, minmax(0, 1fr))' }));
});
export const WideNarrowPage = forwardRef(function WideNarrowPage({ a, b, ...restProps }, ref) {
    return (_jsx(PageLayout, { regions: [a, b], ref: ref, ...restProps, cols: 'minmax(0, 2fr) minmax(0, 1fr)' }));
});
export const NarrowWidePage = forwardRef(function NarrowWidePage({ a, b, ...restProps }, ref) {
    return (_jsx(PageLayout, { regions: [a, b], ref: ref, ...restProps, cols: 'minmax(0, 1fr) minmax(0, 2fr)' }));
});
export const WideWideNarrowPage = forwardRef(function WideWideNarrowPage({ a, b, c, ...restProps }, ref) {
    return (_jsx(PageLayout, { regions: [a, b, c], ref: ref, ...restProps, cols: 'repeat(2, minmax(0, 2fr)) minmax(0, 1fr)' }));
});
export const NarrowWideWidePage = forwardRef(function NarrowWideWidePage({ a, b, c, ...restProps }, ref) {
    return (_jsx(PageLayout, { regions: [a, b, c], ref: ref, ...restProps, cols: 'minmax(0, 1fr) repeat(2, minmax(0, 2fr))' }));
});
export const NarrowWideNarrowPage = forwardRef(function NarrowWideNarrowPage({ a, b, c, ...restProps }, ref) {
