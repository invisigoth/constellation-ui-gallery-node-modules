...
export const StyledDay = styled(StyledPick)(props => {
    const { theme: { base: { palette: { interactive }, 'disabled-opacity': disabledOpacity }, components: { 'form-control': { 'foreground-color': foreground } } }, current, highlighted, dayInNexOrPrevMonth } = props;
