...
import { useAfterInitialEffect, useConsolidatedRef, useItemIntersection, useI18n, useDirection, useLiveLog } from '../../hooks';
...
const MenuList = forwardRef(function MenuListFunction({ items, parent, id, menuRole, ...restProps }, ref) {
    const t = useI18n();
    ...
    const { scrollAt, 'aria-label': label, loadMore, loading, emptyText, currentItemId, onItemExpand, focusControl, updateActiveDescendants, setFocusReturnEl, onItemCollapse } = useContext(MenuContext);
