...
import { useAfterInitialEffect, useConsolidatedRef, useI18n, useItemIntersection, useLiveLog } from '../../hooks';
...
const FlyoutMenuList = forwardRef(function FlyoutMenuListFunction({ items, parent, menuRole }, ref) {
    const t = useI18n();
