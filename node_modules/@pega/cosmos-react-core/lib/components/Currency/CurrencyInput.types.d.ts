import { NoChildrenProp, OmitStrict, TestIdProp } from '../../types';
import type { NumberInputProps } from '../Number/NumberInput.types';
export default interface CurrencyInputProps extends OmitStrict<NumberInputProps, 'numberOfDecimals'>, NoChildrenProp, TestIdProp {
