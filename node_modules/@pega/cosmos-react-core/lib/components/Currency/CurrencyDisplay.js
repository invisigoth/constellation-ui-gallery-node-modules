...
const CurrencyDisplay = forwardRef(function CurrencyDisplay({ value, currencyISOCode, formattingOptions: { currency = 'symbol', negative = 'minus-sign', notation = 'standard', groupSeparators = true, fractionDigits } = {}, ...restProps }, ref) {
    ...
    return (_jsx("span", { ref: ref, ...restProps, children: value || value === 0 ? (_jsxs(_Fragment, { children: [_jsx("span", { "aria-hidden": 'true', children: formatCurrency(value, { locale, options }) }), _jsx(VisuallyHiddenText, { children: formatCurrency(value, { locale, options: srOptions }) })] })) : (_jsx(NoValue, {})) }));
});
